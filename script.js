document.addEventListener("DOMContentLoaded", () => {
  const questions = [
    ...
    //third batch
    {
        question: "The following are disputes that can be resolved with ADR, except?",
        options: {
            A: "Business disputes",
    ...
    {
        question: "Which conflict analysis tool helps to link the causes and effects of a conflict?",
        options: {
            A: "Map",
            B: "Onion",
            C: "Conflict Tree",
    ...
    {
        question: "The last step in the final hearing of an Arbitration Process is _______________?",
        options: {
            A: "issue of award",
            B: "closing argument",
    ...
    {
        question: "A Termite is associated with ___________ Conflict Handling Style?",
        options: {
            A: "competitive",
            B: "compromising",
            C: "collaborative",
    ...
    {
        question: "An Owl is associated with ___________ Conflict Handling Style?",
        options: {
            A: "competitive",
            B: "compromising",
            C: "collaborative",
    ...
    {
        question: "Conflict resolution is the process of reaching a/an __________settlement.",
        options: {
            A: "skilful",
            B: "conflict",
            C: "peaceful",
    ...
    {
        question: "__________________ is an extension or elaboration of a negotiation process that involves a third party?",
        options: {
            A: "ADR",
            B: "Negotiation",
            C: "Mediation",
    ...
    //4th batch
    {
        question: "Decision/agreement made after an arbitration is called a/an ________?",
        options: {
    ...
    {
        question: "An agreement to utilize arbitration instead of going to court to resolve future contract-related conflicts is called _________?",
        options: {
    ...
    {
        question: "Utilizing the court to resolve conflict is known as _________?",
        options: {
            A: "law",
            B: "litigation",
            C: "arbitration",
    ...
    {
        question: "The diagram that showcases the de-escalation, manifestation, escalation, stalemate stages of conflict is called _________?",
        options: {
    ...
    {
        question: "The stage of conflict where there is a total breakdown of law and order is the ________?",
        options: {
            A: "manifest stage",
            B: "escalation stage",
            C: "stalemate stage",
    ...
    {
        question: "The stage of conflict where neither party can win, but neither party want to breakdown, but are war fatigued is the ________?",
        options: {
            A: "de-escalation stage",
            B: "peace stage",
            C: "stalemate Stage",
    ...
    {
        question: "The stage of conflict where the intrinsic and immediate causes of a conflict are addressed is the ___________?",
        options: {
            A: "peace stage",
    ...
    {
        question: "The year _________ was proclaimed as the International year for the Culture of Peace?",
        options: {
            A: "2010",
            B: "1945",
            C: "2000",
    ...
    {
        question: "Due to rampant insecurity, _________ could be tagged as a failed state?",
        options: {
            A: "Somalia",
            B: "Morocco",
            C: "Zimbabwe",
    ...
    {
        question: "The following countries are the permanent members of the United Nations Security Council except?",
        options: {
            A: "USA",
            B: "Germany",
            C: "China",
    ...
    {
        question: "The following are the elements in the United Nations Agenda for Peace, except?",
        options: {
            A: "Peace Support",
            B: "Peace Making",
            C: "Peace Building",
    ...
    {
        question: "The use of overwhelming surprise force by heavily armed Personnel to bring peace to a society is called ________?",
        options: {
            A: "War",
            B: "Peace Keeping",
            C: "War Enforcement",
    ...
    {
        question: "Conflict is from the Latin word ‘confligere’ which means to ____________?",
        options: {
            A: "disagree",
            B: "compete",
            C: "strike together",
    ...
    {
        question: "The use of early warning, shuttle diplomacy, and fact-finding to maintain peace in a society is called _________?",
        options: {
            A: "peace diplomacy",
    ...
    {
        question: "The following are areas of action of the United Nation’s Agenda for Peace, except?",
        options: {
    ...
    {
        question: "The Second World War (WWII) started in ___________ and ended in ___________.",
        options: {
            A: "1939, 1945",
            B: "1945, 1950",
            C: "1930, 1939",
    ...
    {
        question: "The Nigerian Civil War was between the year _____________ and ______________.",
        options: {
            A: "1970, 1975",
            B: "1960, 1963",
            C: "1963, 1967",
    ...
    {
        question: "These are the types of parties/stakeholders in a conflict, except?",
        options: {
            A: "Secondary parties",
            B: "Shadow parties",
            C: "Tertiary parties",
    ...
    {
        question: "The measures for preventive diplomacy include one of the following?",
        options: {
            A: "Early warning",
            B: "Mediation",
    ...
    {
        question: "The stage in Arbitration where parties attempt to identify and track down all the documents, information and witnesses they need to defend their claim is __________?",
        options: {
            A: "Discovery",
            B: "Identification",
            C: "Trial Prep",
    ...
    {
        question: "The individual that has low concern for self and high concern for others is a/an _________?",
        options: {
            A: "Competitor",
            B: "Collaborator",
            C: "Avoider",
    ...
    {
        question: "The individual that has low concern for self and low concern for others is a/an _________?",
        options: {
            A: "Competitor",
            B: "Collaborator",
            C: "Avoider",
    ...
    {
        question: "A conflict characterized by violence is known as _____________?",
        options: {
    ...
    {
        question: "A level of conflict that is accompanied by change within an individual is called?",
        options: {
            A: "Change Conflict",
    ...
    {
        question: "It has become evident today that people can die for what they believe and identify with. This is an example of what type of conflict?",
        options: {
            A: "Information",
            B: "Value system",
            C: "Resources",
    ...
    {
        question: "Violence is the use of patient force to injure, damage or destroy.",
        options: {
            A: "False",
            B: "True",
            C: "Maybe",
    ...
    {
        question: "One of the following is not Maslow’s classification of Human needs",
        options: {
            A: "Esteem needs",
            B: "Social needs",
            C: "Safety needs",
    ...
    {
        question: "The following are elements for analysis during conflict analysis, except?",
        options: {
            A: "Conflict Dynamics",
            B: "Conflict Profile",
            C: "Causal Analysis",
    ...
    {
        question: "In analysing the profile or context of a conflict, the following dimensions are considered, except?",
        options: {
            A: "Immediate Past",
            B: "The current event",
            C: "Trigger",
    ...
    {
        question: "In analysing the causal or issues of a conflict, the following are considered, except?",
        options: {
            A: "Trigger",
            B: "Distant Past",
            C: "Structural causes",
    ...
    {
        question: "Position, Interest, and Needs of conflicting parties are important for conflict analysis. Here, Position means?",
        options: {
    ...
    {
        question: "Position, Interest, and Needs of conflicting parties are important for conflict analysis. Here, Interest means?",
        options: {
            A: "What parties say they want",
            B: "What parties really want",
            C: "What actors must have",
    ...
    {
        question: "Position, Interest, and Needs of conflicting parties are important for conflict analysis. Here, Needs means?",
        options: {
            A: "What parties say they want",
            B: "What parties really want",
            C: "What actors must have",
    ...
    {
        question: "Which conflict analysis tool is used to analyse the structural causes of a conflict?",
        options: {
            A: "Onion",
            B: "Conflict tree",
            C: "Conflict map",
    ...
    {
        question: "The following are levels at which conflict transforms situations except?",
        options: {
            A: "Personal",
            B: "Relational",
            C: "Cultural",
    ...
    {
        question: "The following terms are used interchangeably with conflict management, except?",
        options: {
    ...
    {
        question: "When an Avoider is in conflict with a competitor it brings a _______________ outcome?",
        options: {
            A: "Win-win",
            B: "Lose-win",
    ...
    {
        question: "The International Peace Day is celebrated annually on __________?",
        options: {
            A: "23rd September",
            B: "21st September",
            C: "23rd August",
    ...
    {
        question: "According to Fisher and Ury, the following are principles of Negotiation except?",
        options: {
            A: "People",
            B: "Criteria",
            C: "Quid pro quo",
    ...
    {
        question: "An action of strife that represents how the pursuance of needs are expressed is known as ________",
        options: {
            A: "Struggle",
            B: "Conflict",
            C: "Opposition",
    ...
    {
        question: "_____________ describes the methods and procedures used in resolving disputes as an alternative mechanism to the court",
        options: {
            A: "ADR",
            B: "DDR",
            C: "SSR",
    ...
    {
        question: "In non-binding ADR, after the parties have agreed on an amicable resolution,",
        options: {
    ...
    {
        question: "Which conflict handling style do you liken to principled negotiation?",
        options: {
            A: "Accommodation",
            B: "Collaboration",
            C: "Competitor",
    ...
    {
        question: "In a negotiation which actor or their representatives’ bargains?",
        options: {
            A: "Primary",
            B: "Secondary",
            C: "Shadow party",
    ...
    {
        question: "Preventive Diplomacy is most appropriate in which stage of conflict?",
        options: {
            A: "Crisis Stage",
            B: "Stalemate stage",
            C: "Escalation Stage",
    ...
    {
        question: "Peace Enforcement is most appropriate in which stage of conflict?",
        options: {
            A: "Manifestation Stage",
            B: "Crisis Stage",
            C: "Resolution Stage",
    ...
    {
        question: "During the cold war, the Military Alliance of the USA and West is _________?",
        options: {
            A: "Warsaw Pact",
            B: "Security Council",
            C: "Desert Storm",
    ...
    {
        question: "During the cold war, the Military Alliance of the Soviet Union and the East is _______?",
        options: {
            A: "NATO",
            B: "Warsaw Pact",
            C: "Desert Storm",
    ...
    {
        question: "__________ is the report written by Boutros-Ghali as mechanisms to be utilized to respond to conflict in the post-cold war era.",
        options: {
    ...
    {
        question: "The following are the Permanent 5 Members of the United Nations security Council except?",
        options: {
            A: "France",
            B: "United Kingdom",
            C: "Germany",
